package editar.imagenes.objects;
...
public class VerySimpleImageWriter {
    ...
    public VerySimpleImageWriter(BufferedImage bi) {
        ...
        puntos = new int[ancho * alto];
        bi.getRGB(0, 0, ancho, alto, puntos, 0, ancho);
...
//        }
    ...
    public void escribirArchivo(String archivo) {
        ...
        try {
            ImageIO.write(bi, "png", new File(archivo));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) {
        ...
        obj.escribirArchivo("C:\\Users\\susi_\\Downloads\\color-fondo-imagen-r2.png");
    }
